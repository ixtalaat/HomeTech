...
class RequestStatusService
{
    ...
    private const TRANSITIONS = [
        ...
        'scheduled' => [RequestStatus::TechnicianAssigned, RequestStatus::Approved, RequestStatus::InProgress, RequestStatus::TechnicianOnWay, RequestStatus::Cancelled],
        'technician_on_way' => [RequestStatus::InProgress, RequestStatus::TechnicianAssigned, RequestStatus::Approved, RequestStatus::Cancelled],
