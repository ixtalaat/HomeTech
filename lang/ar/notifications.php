...
return [
    ...
    'invoice_issued' => 'تم إصدار الفاتورة :number (:total ريال) لطلبك #:id.',
    'payment_received' => 'تم استلام دفعة :amount ريال للفاتورة :number. المتبقي: :remaining ريال.',
    ...
    'additional_work_approval' => 'مطلوب موافقة: :description (:cost ريال) للطلب #:id.',
