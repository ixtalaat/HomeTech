...
return [
    ...
    'invoice_issued' => 'Invoice :number (:total SAR) was issued for your request #:id.',
    'payment_received' => 'Payment of :amount SAR received for invoice :number. Remaining: :remaining SAR.',
    ...
    'additional_work_approval' => 'Approval needed: :description (:cost SAR) for request #:id.',
