...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">Add Address</h2>
        <p class="mt-1 text-sm text-slate-500">Save a service location for future maintenance requests.</p>
    </div>
        ...
        <form method="POST" action="{{ route('addresses.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="Home, Office..."
