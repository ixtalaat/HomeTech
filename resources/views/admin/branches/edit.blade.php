...
@section('title', __('Edit Branch: :name', ['name' => $branch->name]))
...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">{{ __('Edit Branch: :name', ['name' => $branch->name]) }}</h2>
    </div>
        ...
        <form method="POST" action="{{ route('admin.branches.update', $branch) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" id="priority" name="priority" value="{{ old('priority', $branch->priority) }}" min="0"
            ...
            <div>
                ...
                <input type="text" id="cities" name="cities" value="{{ old('cities', $branch->cities->pluck('name')->join(', ')) }}" dir="auto"
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 sm:p-5">
                ...
                @php $managerMode = old('manager_mode', $branch->manager_user_id ? 'existing' : 'none'); @endphp
            ...
            <div class="flex items-center gap-3">
                ...
                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $branch->is_active ? '1' : '0') == '1' ? 'checked' : '' }}
            ...
            <div class="flex items-center justify-end gap-3 border-t border-slate-100 pt-6">
                ...
                <button type="submit" class="primary-button">{{ __('Update Branch') }}</button>
            </div>
        </form>
    </div>
</div>
