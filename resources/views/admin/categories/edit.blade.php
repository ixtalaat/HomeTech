...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">Edit Category: {{ $category->name }}</h2>
        <p class="mt-1 text-sm text-slate-500">Update category details and availability status.</p>
    </div>
