...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">Add Inventory Item</h2>
        <p class="mt-1 text-sm text-slate-500">Opening stock is recorded as a purchase movement.</p>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
        <form method="POST" action="{{ route('admin.inventory.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                ...
                <div>
                    <label for="current_stock" class="form-label">Opening Stock <span class="text-rose-500">*</span></label>
            ...
            <div class="flex items-center justify-end gap-3 border-t border-slate-100 pt-6">
                <a href="{{ route('admin.inventory.index') }}" class="secondary-button">Cancel</a>
