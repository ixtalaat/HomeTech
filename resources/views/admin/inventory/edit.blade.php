...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">Edit Item: {{ $inventoryItem->name }}</h2>
        <p class="mt-1 text-sm text-slate-500">Stock levels change only through movements, never by direct edit.</p>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
        <form method="POST" action="{{ route('admin.inventory.update', $inventoryItem) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                <div>
                    <label for="unit" class="form-label">Unit <span class="text-rose-500">*</span></label>
                ...
                <div>
                    <label for="low_stock_threshold" class="form-label">Low-Stock Threshold <span class="text-rose-500">*</span></label>
                ...
                <div>
                    <label for="unit_cost" class="form-label">Unit Cost (EGP) <span class="text-rose-500">*</span></label>
            ...
            <div class="flex items-center justify-end gap-3 border-t border-slate-100 pt-6">
                <a href="{{ route('admin.inventory.show', $inventoryItem) }}" class="secondary-button">Cancel</a>
                <button type="submit" class="primary-button">Update Item</button>
            </div>
        </form>
    </div>
</div>
