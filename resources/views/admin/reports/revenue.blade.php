...
<div class="mx-auto max-w-7xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">{{ __('Revenue Reports') }}</h2>
    </div>

    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h3 class="text-sm font-extrabold text-slate-900">{{ __('Daily Revenue (last 30 days)') }}</h3>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h3 class="text-sm font-extrabold text-slate-900">{{ __('Monthly Revenue (last 12 months)') }}</h3>
            <ul class="mt-3 max-h-72 space-y-1 overflow-y-auto text-sm">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h3 class="text-sm font-extrabold text-slate-900">{{ __('Revenue by Service') }}</h3>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h3 class="text-sm font-extrabold text-slate-900">{{ __('Revenue by Technician') }}</h3>
            <ul class="mt-3 space-y-1 text-sm">
    ...
    <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h3 class="text-sm font-extrabold text-slate-900">{{ __('Outstanding Invoices') }}</h3>
        <ul class="mt-3 space-y-1 text-sm">
