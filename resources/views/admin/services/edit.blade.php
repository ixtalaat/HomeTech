...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        ...
        <h2 class="mt-2 font-display text-2xl font-extrabold text-slate-900">Edit Service: {{ $service->name }}</h2>
        <p class="mt-1 text-sm text-slate-500">Update pricing, category, description, or activation status.</p>
    </div>
