...
<div class="mx-auto max-w-7xl">
    <div class="mb-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <p class="text-xs font-bold uppercase tracking-[0.18em] text-teal-600">{{ __('Branch overview') }}</p>
            <h2 class="mt-1 font-display text-2xl font-extrabold text-slate-900">{{ $branch->name }}</h2>
    ...
    <div class="grid grid-cols-2 gap-4 lg:grid-cols-3 xl:grid-cols-5">
        <div class="stat-card">
            ...
            <span>
                <span class="block text-xs font-bold uppercase tracking-wider text-slate-500">{{ __('Technicians') }}</span>
        ...
        <div class="stat-card">
            ...
            <span>
                <span class="block text-xs font-bold uppercase tracking-wider text-slate-500">{{ __('Unassigned Jobs') }}</span>
        ...
        <div class="stat-card">
            ...
            <span>
                <span class="block text-xs font-bold uppercase tracking-wider text-slate-500">{{ __('30-Day Revenue') }}</span>
