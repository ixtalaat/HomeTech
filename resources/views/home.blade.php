...
<body class="bg-slate-950 text-white antialiased">
    ...
    <main class="relative overflow-hidden">
        <div class="pointer-events-none absolute -left-24 top-10 h-96 w-96 rounded-full bg-teal-500/20 blur-3xl"></div>
        <div class="pointer-events-none absolute right-0 top-0 h-[32rem] w-[32rem] rounded-full bg-sky-500/10 blur-3xl">
        </div>
        <section
            ...
            <div>
                <p
                    class="inline-flex items-center gap-2 rounded-full border-teal-400/30 bg-teal-400/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-teal-300">
                    <span class="h-2 w-2 rounded-full bg-teal-300"></span> The smarter way to care for home</p>
                <h1
                    class="mt-7 max-w-2xl font-display text-5xl font-extrabold leading-[1.08] tracking-tight sm:text-6xl">
                    A better home starts with <span class="text-teal-400">better care.</span></h1>
                <p class="mt-7 max-w-xl text-lg leading-8 text-slate-300">Book trusted maintenance, keep track of every
                ...
                <div class="mt-9 flex-col gap-3 sm:flex-row"><a href="{{ route('register') }}"
                        ...
                        href="#how-it-works"
                        class="inline-flex items-center justify-center rounded-xl border-slate-700 px-6 py-3.5 text-sm font-bold text-slate-200 transition hover:border-slate-500 hover:bg-slate-900">How
                        it works</a></div>
                <div class="mt-10 flex items-center gap-4 text-sm text-slate-400">
                    <div class="flex -space-x-2"><span
                            class="flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-950 bg-amber-300 text-xs font-bold text-amber-900">A</span><span
                            class="flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-950 bg-sky-300 text-xs font-bold text-sky-900">M</span><span
                            class="flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-950 bg-rose-300 text-xs font-bold text-rose-900">J</span>
                    </div><span>Simple service coordination for modern households.</span>
                </div>
            </div>
            <div class="relative">
                <div
                    class="rounded-[2rem] border-white/10 bg-white/[0.07] p-3 shadow-2xl shadow-teal-950/30 backdrop-blur">
                    <div class="rounded-[1.5rem] bg-slate-900 p-6 sm:p-8">
        ...
        <section id="how-it-works" class="border-t border-white/10 bg-slate-900/70">
            <div class="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-12">
                ...
                <div class="mt-12 grid gap-5 md:grid-cols-3">
                    <div class="rounded-3xl border-white/10 bg-white/[0.04] p-6"><span
                        ...
                        <p class="mt-3 text-sm leading-6 text-slate-400">Share the details and we’ll help match the
                    ...
                    <div class="rounded-3xl border-white/10 bg-white/[0.04] p-6"><span
                        ...
                        <p class="mt-3 text-sm leading-6 text-slate-400">Get clear scheduling updates and know who is
                    ...
                    <div class="rounded-3xl border-white/10 bg-white/[0.04] p-6"><span
                        ...
                        <p class="mt-3 text-sm leading-6 text-slate-400">Follow your service from request to completion
