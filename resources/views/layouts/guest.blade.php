        ...
        <section class="relative hidden overflow-hidden bg-teal-50 p-12 text-slate-900 lg:flex lg:flex-col lg:justify-between">
            ...
            <div class="relative">
                ...
                <div class="mt-28 max-w-lg">
                    ...
                    <p class="mt-6 max-w-md text-lg leading-8 text-slate-600">Book trusted maintenance, follow your
                        service, and keep your home running smoothly.</p>
                </div>
            </div>
            <p class="relative text-sm text-slate-500">Trusted service coordination for modern households.</p>
        </section>
