...
<div class="mx-auto max-w-3xl">
    <div class="mb-8">
        <h2 class="font-display text-2xl font-extrabold text-slate-900">Notifications</h2>
        <p class="mt-1 text-sm text-slate-500">Updates about your requests, jobs, invoices, and approvals.</p>
    </div>
    ...
    <div class="space-y-3">
        @forelse ($notifications as $notification)
            <a href="{{ route('notifications.show', $notification) }}"
                ...
                <p class="text-sm font-medium text-slate-900">{{ $notification->data['message'] ?? 'Update' }}</p>
